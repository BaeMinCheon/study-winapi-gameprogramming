	...
	try {
		/* Setting Window */ {
			...
			*pAtom = RegisterClassEx(pWcex);
			...
			// Create Window
			hWnd = CreateWindowEx(NULL, pszApplicationName, pszApplicationName, WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, nullptr, nullptr, p_hInstance, nullptr);
			if(!hWnd) {
				throw GetLastError();
			}

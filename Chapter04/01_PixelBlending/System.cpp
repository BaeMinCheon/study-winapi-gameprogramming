	...
	_In_ LPARAM p_lParam)
{
	...
	case WM_CREATE:
		...
		pImgList[0] = MyLoadImage(L"Clover/0.raw", 110, 150);
		pImgList[1] = MyLoadImage(L"Clover/1.raw", 110, 150);
		pImgList[2] = MyLoadImage(L"Clover/2.raw", 110, 150);
		pImgList[3] = MyLoadImage(L"Clover/3.raw", 110, 150);
		pImgList[4] = MyLoadImage(L"Clover/4.raw", 110, 150);
		break;
	case WM_DESTROY:
...
HRESULT __stdcall OnPaint(_In_ HWND p_hWnd)
{
	...
	MyDrawImage(pImgList[0], 10, 10, 110, 150);
	MyDrawImage(pImgList[1], 10, 30, 110, 150);
	MyDrawImage(pImgList[2], 10, 50, 110, 150);
	MyDrawImage(pImgList[3], 10, 70, 110, 150);
	MyDrawImage(pImgList[4], 10, 90, 110, 150);
